...
QString CoinControlDialog::getPriorityLabel(double dPriority)
{
    ...
    {
        if      (dPriority > 5760000000ULL)   return tr("CVCest");
        else if (dPriority > 576000000ULL)    return tr("CVC");
        else if (dPriority > 57600000ULL)     return tr("medium-CVC");
